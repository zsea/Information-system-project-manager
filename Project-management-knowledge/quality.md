...
* 新七种工具基本是整理分析语言文字（非数据）资料，着重来解决规划阶段的问题。
    > 矩树相亲策动优，主要用于质量保证过程
    * 矩阵图
    * 树状图
    * 相互关系图
...
```memo
趋因只点劣质茶，钜树相亲策动优。
有一个叫趋英的人在相亲时只敢点最便宜的劣质茶，为什么？家里穷呀。原来，她是钜了家里的树，卖了钱，来相亲的。可见这次相亲的策划活动有多优秀。
```
...
![趋势分析图](/assests/images/7-o-trend.png)

#### 因果图

也称石川图、鱼骨图。用来确定问题的根本原因。

![因果图](/assests/images/7-o-fishbone.png)

![鱼骨图分析近视的根本原因](/assests/images/7-o-fishbone-eye.png)

鱼骨图分析近视的根本原因

#### 直方图

用于集中**描述**趋势、分散程度和**统计**分布形状。与排列图不同，不考虑时间对分布的影响。

![直方图](/assests/images/7-o-histogram.png)

#### 散点图

也称相关图。显示两个变量之间是否有关系，一条斜线上的点距离越近，相关性就越强。

![散点图](/assests/images/7-o-scatter.png)

#### 排列图

也称帕累托图。用于集中解决关键问题，发现造成小部分问题的大多数原因。

![帕累托图](/assests/images/7-o-pareto.png)

#### 控制图

也称七点图。用来确定一个过程是否稳定，或是否具有可预测的绩效。

![控制图](/assests/images/7-o-control.png)

#### 检查表

用于数据收集。

![检查表](/assests/images/7-o-checklist.png)

### 新七种工具

#### 矩阵图

质量管理和控制的工具，对数据结构进行分析，在行列交叉的位置展示因素、原因和目标之间的强弱关系

![矩阵图](/assests/images/7-n-matrix.png)

![矩阵图](/assests/images/7-n-matrix-2.png)

![矩阵图](/assests/images/7-n-matrix-3.png)

#### 树形图

也称系统图。用于表现层次结构。

![树形图](/assests/images/7-n-tree.png)

#### 相互关联图

也称关联图。可以使用其它工具产生的数据来绘制关联图。用于在交叉逻辑关系中创新性的解决问题。

![关联图](/assests/images/7-n-association.png)
...
![亲和图](/assests/images/7-n-affinity.png)

![亲和图](/assests/images/7-n-affinity-2.png)
...
预测可能破坏目标的中间环境，帮助团队制定应急计划。用于理解一个目标与达成此目标之间的步骤关系。

![亲和图](/assests/images/7-n-pdpc.png)

#### 活动网络图

![活动网络图](/assests/images/7-n-action.png)
...
0. 确定质量的相关体系和标准
1. 要制定出切实可行的质量管理计划
2. 应该按排独立于项目组的QA工作人员负责QA工作
3. 对软件开发的过程实施质量保证或审计
4. 加强技术评审工作，注重对需求、设计等文档的技术评审
5. 注重测试工作，应安排相对独立的测试人员
6. 对发现的缺陷进行统计分析工作，确保最终的软件产品的质量
7. 做好版本控制，加强配置管理

```memo
最高的是体系和标准（比如CMMI3）。然后可发为开发前、开发中、开发完成后。
开发前：制定计划、安排独立的QA
开发中：对开发过程实施质量保证、审计，对相关文档进行技术评审。同时做好代码的版本控制（配置管理）。
开发后：安排独立的测试。对缺陷进行分析（并解决），确保最终部品的质量。
```

### QA与QC

**QA的职责包括**：过程的指导、评审、改进、度量以及产品的审计
* 导师的角色
> 在项目前期，辅助项目经理制定项目计划，包括根据质量体系中的标准过程裁剪得到项目的过程，帮助项目进行估算，设定质量目标等。对项目成员进行过程和规范的培训以前在过程中进行指导。
* 警察的角色
> 在项目过程中，有选择性的参加项目的技术评审，定期对项目的工作产品和过程进行审计和评审。
* 医生的角色
> 在项目过程中，可以承担收集、统计、分析度量数据的工作，用于支持管理决策。

```memo
导师：在事前进行指导
警察：在项目过程中对项目的过程进行审计和评审
医生：收集数据，分析问题，帮助管理解决问题
```

|QA(Quality Assruance)|QA(Quality Control)|
|---|---|
|事前|事后|
|过程中|产品|
|关注如何降低缺陷、成本、返工|关注如何解决缺陷|
|每个人的职责|QC工程师的职责|
...
```memo
一个好的项目需要领导、组织、员工、成本、经验等方面的努力。

领导重视需要老板领导质量方针、标准、要求、流程、工具、资源。即老板要重视质量的各个方面：方针、标准、质量控制和质量保证，提供相应资源。
组织方面需要建立组织级的管理体系（项目管理体系和质量管理体系）
员工方面主要是建立激励制度
成本方面主要是理解各种成本（一致性、非一致性、预防、评估、缺陷等成本）
经验主要是文档和成熟度模型
```
...
graph TB;
    ...
    N-->Q
    N-->R
    class A,B,G,H,I,J,M,O,P,Q,R INNER
    class F,L,N PROCESS
```
